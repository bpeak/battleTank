...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! socket.io-client */ \"./node_modules/socket.io-client/lib/index.js\");\n/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(socket_io_client__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _managers_GameStateManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./managers/GameStateManager */ \"./game/managers/GameStateManager.js\");\n/* harmony import */ var _managers_TouchPadManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./managers/TouchPadManager */ \"./game/managers/TouchPadManager.js\");\n/* harmony import */ var _managers_UserManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./managers/UserManager */ \"./game/managers/UserManager.js\");\n/* harmony import */ var _managers_ImageManager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./managers/ImageManager */ \"./game/managers/ImageManager.js\");\n/* harmony import */ var _utils_getMousePos__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/getMousePos */ \"./game/utils/getMousePos.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n //managers\n\n\n\n\n //utils\n\n\nvar mainCanvas = document.getElementById(\"mainCanvas\");\nvar mainCtx = mainCanvas.getContext(\"2d\");\nmainCanvas.width = 3000;\nmainCanvas.height = 1500;\nvar gameCanvas = document.createElement(\"canvas\");\nvar gameCtx = gameCanvas.getContext(\"2d\");\ngameCanvas.width = mainCanvas.width;\ngameCanvas.height = mainCanvas.height;\nvar minimapCanvas = document.createElement(\"canvas\");\nvar minimapCtx = minimapCanvas.getContext(\"2d\");\nminimapCanvas.width = mainCanvas.width;\nminimapCanvas.height = mainCanvas.height;\nvar bufferCanvas = document.createElement(\"canvas\");\nvar bufferCtx = bufferCanvas.getContext(\"2d\");\nbufferCanvas.width = mainCanvas.width;\nbufferCanvas.height = mainCanvas.height; //create Managers\n\nvar touchPadManager = Object(_managers_TouchPadManager__WEBPACK_IMPORTED_MODULE_2__[\"default\"])({\n  canvasWidth: mainCanvas.width,\n  canvasHeight: mainCanvas.height\n});\nvar gameStateManager = Object(_managers_GameStateManager__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\nvar userManager = Object(_managers_UserManager__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\nvar imageManager = Object(_managers_ImageManager__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(); //create socket\n\nvar socket = socket_io_client__WEBPACK_IMPORTED_MODULE_0___default()(\"172.30.1.30\");\nsocket.on(\"state-init\",\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(data) {\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.prev = 0;\n            gameStateManager.initMaps(data.state.maps, mainCanvas.width, mainCanvas.height);\n            gameStateManager.updateState(data.state);\n            userManager.updateSocketId(data.socketId);\n            _context.next = 6;\n            return imageManager.load();\n\n          case 6:\n            gameStateManager.updateProcessState(\"START\");\n            _context.next = 11;\n            break;\n\n          case 9:\n            _context.prev = 9;\n            _context.t0 = _context[\"catch\"](0);\n\n          case 11:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[0, 9]]);\n  }));\n\n  return function (_x) {\n    return _ref.apply(this, arguments);\n  };\n}());\n\nvar log = function log(data) {\n  socket.emit(\"log\", data);\n};\n\nsocket.on(\"user-init\", function (user) {});\nsocket.on(\"state-new\", function (newState) {\n  gameStateManager.updateState(newState);\n});\nsocket.emit(\"player-new\");\nsocket.on(\"newState\", function (data) {});\ndocument.getElementById(\"btn\").addEventListener(\"click\", function () {\n  document.documentElement.webkitRequestFullScreen();\n  document.getElementById(\"btn\").remove();\n  log(mainCanvas.width);\n});\nmainCanvas.addEventListener(\"touchmove\", function (e) {\n  for (var i = 0; i < e.touches.length; i++) {\n    var _getMousePos = Object(_utils_getMousePos__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(mainCanvas, {\n      clientX: e.touches[i].clientX,\n      clientY: e.touches[i].clientY\n    }),\n        mouseX = _getMousePos.mouseX,\n        mouseY = _getMousePos.mouseY;\n\n    touchPadManager.moveHandler({\n      mouseX: mouseX,\n      mouseY: mouseY\n    });\n  } // const mouseEvent = new MouseEvent(\"mousemove\", {\n  //     clientX: touch.clientX,\n  //     clientY: touch.clientY,\n  // })\n  // mainCanvas.dispatchEvent(mouseEvent)\n\n});\nmainCanvas.addEventListener(\"touchstart\", function (e) {\n  for (var i = 0; i < e.touches.length; i++) {\n    var _getMousePos2 = Object(_utils_getMousePos__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(mainCanvas, {\n      clientX: e.touches[i].clientX,\n      clientY: e.touches[i].clientY\n    }),\n        mouseX = _getMousePos2.mouseX,\n        mouseY = _getMousePos2.mouseY;\n\n    touchPadManager.startHandler({\n      mouseX: mouseX,\n      mouseY: mouseY\n    });\n  }\n});\nmainCanvas.addEventListener(\"click\", function (e) {\n  var _getMousePos3 = Object(_utils_getMousePos__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(mainCanvas, {\n    clientX: e.clientX,\n    clientY: e.clientY\n  }),\n      mouseX = _getMousePos3.mouseX,\n      mouseY = _getMousePos3.mouseY;\n\n  touchPadManager.startHandler({\n    mouseX: mouseX,\n    mouseY: mouseY\n  });\n});\nmainCanvas.addEventListener(\"touchend\", function (e) {\n  for (var i = 0; i < e.changedTouches.length; i++) {\n    var _getMousePos4 = Object(_utils_getMousePos__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(mainCanvas, {\n      clientX: e.changedTouches[i].clientX,\n      clientY: e.changedTouches[i].clientY\n    }),\n        mouseX = _getMousePos4.mouseX,\n        mouseY = _getMousePos4.mouseY;\n\n    touchPadManager.endHandler({\n      mouseX: mouseX,\n      mouseY: mouseY\n    });\n  } // const touch = e.touches[0]\n  // const { mouseX, mouseY } = getMousePos(mainCanvas, { clientX : touch.clientX, clientY : touch.clientY })\n  // touchPadManager.updateBallPosition({\n  //     distanceX : 0,\n  //     distanceY : 0,\n  //     sinE : 0,\n  //     cosE : 0,\n  // })\n\n});\nmainCanvas.addEventListener(\"mousemove\", function (e) {\n  var _getMousePos5 = Object(_utils_getMousePos__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(mainCanvas, e),\n      mouseX = _getMousePos5.mouseX,\n      mouseY = _getMousePos5.mouseY;\n\n  touchPadManager.moveHandler({\n    mouseX: mouseX,\n    mouseY: mouseY\n  }); // const {\n  //     bgBallR,\n  //     bgBallX,\n  //     bgBallY,\n  // } = touchPadManager.getStatus()\n  // const distanceX = mouseX - bgBallX\n  // const distanceY = mouseY - bgBallY\n  // const distanceR = Math.sqrt(Math.pow(distanceX, 2) + Math.pow(distanceY, 2))\n  // const sinE = distanceY / distanceR \n  // const cosE = distanceX / distanceR\n  // if(distanceR <= bgBallR){\n  //     touchPadManager.updateBallPosition({\n  //         distanceX,\n  //         distanceY,\n  //         sinE,\n  //         cosE,\n  //     })\n  //     log(\n  //         `${distanceX}, ${distanceY} DX DY`\n  //     )\n  // }\n  // socket.emit(\"ready\", { test : getMousePos(mainCanvas, e)})\n}); // mainCanvas.addEventListener(\"mousemove\", (e) => {\n//     console.log(\"엥?\")\n//     const { mouseX , mouseY } = getMousePos(mainCanvas, e)\n//     const {\n//         bgBallR,\n//         bgBallX,\n//         bgBallY,\n//     } = touchPadManager.getStatus()\n//     const distanceX = bgBallX - mouseX\n//     const distanceY = bgBallY - mouseY\n//     const ddr = Math.sqrt(Math.pow(distanceX) + Math.pow(distanceY))\n//     console.log(ddr, '이게 작으면데 머보다? ', bgBallR)\n//     log({\n//         x,\n//         y,\n//     })\n//     // socket.emit(\"ready\", { test : getMousePos(mainCanvas, e)})\n// })\n// const keyManager = (() => {\n//     const KEYCODE_LEFT = 37\n//     const KEYCODE_UP = 38\n//     const KEYCODE_RIGHT = 39\n//     const KEYCODE_DOWN = 40\n//     let leftPressed = false\n//     let rightPressed = false\n//     let upPressed = false\n//     let downPressed = false\n//     const getStatus = () => {\n//         return ({\n//             leftPressed,\n//             rightPressed,\n//             upPressed,\n//             downPressed,\n//         })\n//     }\n//     const updateStatusByKeyCode = (keyCode, keyStatus) => {\n//         switch(keyCode){\n//             case KEYCODE_LEFT:\n//             case KEYCODE_RIGHT:\n//             case KEYCODE_DOWN:\n//             case KEYCODE_UP:\n//         }\n//     }\n//     return ({\n//         getStatus,\n//         updateStatusByKeyCode\n//     })\n// })()\n\ndocument.addEventListener(\"keydown\", function (e) {// keyManager.updateStatusByKeyCode(e.keyCode, true)\n});\ndocument.addEventListener(\"keyup\", function (e) {// keyManager.updateStatusByKeyCode(e.keyCode, false)\n});\nsetInterval(function () {\n  update();\n  draw();\n}, 1000 / 60);\n\nfunction update() {\n  //detect mobile 가로 세로\n  if (window.innerWidth < window.innerHeight) {\n    gameStateManager.updateProcessState(\"MENU\");\n  } //update player moving\n\n\n  var _touchPadManager$getS = touchPadManager.getStatus(),\n      sinE = _touchPadManager$getS.sinE,\n      cosE = _touchPadManager$getS.cosE;\n\n  if (sinE !== 0 || cosE !== 0) {\n    socket.emit(\"player-move\", {\n      sinE: sinE,\n      cosE: cosE\n    });\n  } //update shot\n\n\n  var _gameStateManager$get = gameStateManager.getState(),\n      users = _gameStateManager$get.users;\n\n  var mySocketId = userManager.getState().socketId;\n  var me = users[mySocketId];\n\n  var _touchPadManager$getS2 = touchPadManager.getStatus(),\n      btnPressed = _touchPadManager$getS2.btnPressed;\n\n  if (btnPressed) {\n    socket.emit(\"player-shot\", {\n      sinE: me.sinE,\n      cosE: me.cosE,\n      x: me.x,\n      y: me.y\n    });\n    touchPadManager.deactivePressed();\n  }\n}\n\nfunction draw() {\n  //clear\n  gameCtx.clearRect(0, 0, gameCtx.width, gameCtx.height);\n  bufferCtx.clearRect(0, 0, bufferCanvas.width, bufferCanvas.height);\n  mainCtx.clearRect(0, 0, mainCanvas.width, mainCanvas.height);\n  var gameProcessState = gameStateManager.getProcessState();\n\n  if (gameProcessState === \"LOADING\") {\n    return;\n  }\n\n  if (gameProcessState === \"MENU\") {\n    bufferCtx.fillRect(300, 300, 300, 300);\n    mainCtx.drawImage(bufferCanvas, 0, 0, bufferCanvas.width, bufferCanvas.height);\n    return;\n  }\n\n  var _gameStateManager$get2 = gameStateManager.getState(),\n      users = _gameStateManager$get2.users,\n      maps = _gameStateManager$get2.maps;\n\n  var _gameStateManager$get3 = gameStateManager.getConfig(),\n      tileW = _gameStateManager$get3.tileW,\n      tileH = _gameStateManager$get3.tileH; //draw map\n\n\n  for (var row = 0; row < maps.length; row++) {\n    for (var col = 0; col < maps[0].length; col++) {\n      if (maps[row][col] === 0) {\n        gameCtx.fillStyle = \"grey\";\n        gameCtx.fillRect(col * tileW, row * tileH, tileW, tileH);\n      }\n\n      if (maps[row][col] !== 0) {\n        gameCtx.fillStyle = \"black\";\n        gameCtx.fillRect(col * tileW, row * tileH, tileW, tileH);\n      }\n    }\n  } //draw user\n\n\n  var imgs = imageManager.getImgs();\n  var mySocketId = userManager.getState().socketId;\n\n  for (var socketId in users) {\n    if (mySocketId === socketId) {//me\n    } else {} // //others\n      //common\n\n\n    var _users$socketId = users[socketId],\n        x = _users$socketId.x,\n        y = _users$socketId.y,\n        cosE = _users$socketId.cosE,\n        sinE = _users$socketId.sinE;\n    gameCtx.fillStyle = \"red\"; // gameCtx.drawImage(imgs.tank, x, y, 200, 200)\n\n    gameCtx.save(); // move to the middle of where we want to draw our image\n\n    gameCtx.translate(x, y); // rotate around that point, converting our \n    // angle from degrees to radians \n\n    gameCtx.rotate(Math.atan2(sinE, cosE)); // draw it up and to the left by half the width\n    // and height of the image \n\n    gameCtx.drawImage(imgs.tank, -(tileW / 2), -(tileH / 2), tileW, tileH); // and restore the co-ords to how they were when we began\n\n    gameCtx.restore();\n  } //gameCanvas to bufferCanvas by CAM\n\n\n  var me = users[mySocketId];\n  var cam = {\n    w: 1000,\n    h: 500\n  };\n  var srcX = me.x - cam.w;\n  var srcY = me.y - cam.h;\n\n  if (srcX <= 0) {\n    srcX = 0;\n  }\n\n  if (srcX >= gameCanvas.width - cam.w * 2) {\n    srcX = gameCanvas.width - cam.w * 2;\n  }\n\n  if (srcY <= 0) {\n    srcY = 0;\n  }\n\n  if (srcY >= gameCanvas.height - cam.h * 2) {\n    srcY = gameCanvas.height - cam.h * 2;\n  }\n\n  bufferCtx.drawImage(gameCanvas, srcX, srcY, cam.w * 2, cam.h * 2, 0, 0, gameCanvas.width, gameCanvas.height); //draw minimap maps\n\n  for (var _row = 0; _row < maps.length; _row++) {\n    for (var _col = 0; _col < maps[0].length; _col++) {\n      if (maps[_row][_col] === 0) {\n        minimapCtx.fillStyle = \"yellow\";\n        minimapCtx.fillRect(_col * tileW, _row * tileH, tileW, tileH);\n      }\n\n      if (maps[_row][_col] !== 0) {\n        minimapCtx.fillStyle = \"black\";\n        minimapCtx.fillRect(_col * tileW, _row * tileH, tileW, tileH);\n      }\n    }\n  } //draw minimap users\n\n\n  for (var _socketId in users) {\n    if (mySocketId === _socketId) {\n      //me\n      minimapCtx.fillStyle = \"green\";\n    } else {\n      // //others\n      minimapCtx.fillStyle = \"red\";\n    }\n\n    var _users$_socketId = users[_socketId],\n        x = _users$_socketId.x,\n        y = _users$_socketId.y;\n    minimapCtx.beginPath();\n    minimapCtx.arc(x, y, tileW / 2, 0, 2 * Math.PI);\n    minimapCtx.fill();\n    minimapCtx.closePath();\n  } // minimapCtx.arc(100, 100, /50, 0, 2 * Math.PI)\n  //minimap to buffer\n\n\n  bufferCtx.drawImage(minimapCanvas, 0, 0, 300, 300); //draw touchpad\n\n  var _touchPadManager$getS3 = touchPadManager.getStatus(),\n      bgBallR = _touchPadManager$getS3.bgBallR,\n      bgBallX = _touchPadManager$getS3.bgBallX,\n      bgBallY = _touchPadManager$getS3.bgBallY,\n      ballR = _touchPadManager$getS3.ballR,\n      ballX = _touchPadManager$getS3.ballX,\n      ballY = _touchPadManager$getS3.ballY,\n      btnX = _touchPadManager$getS3.btnX,\n      btnY = _touchPadManager$getS3.btnY,\n      btnWidth = _touchPadManager$getS3.btnWidth,\n      btnHeight = _touchPadManager$getS3.btnHeight;\n\n  bufferCtx.beginPath();\n  bufferCtx.arc(bgBallX, bgBallY, bgBallR, 0, 2 * Math.PI);\n  bufferCtx.stroke();\n  bufferCtx.closePath();\n  bufferCtx.beginPath();\n  bufferCtx.arc(ballX, ballY, ballR, 0, 2 * Math.PI);\n  bufferCtx.stroke();\n  bufferCtx.closePath(); //draw touchpad btn\n\n  bufferCtx.fillRect(btnX, btnY, btnWidth, btnHeight); //buffer to main\n\n  mainCtx.drawImage(bufferCanvas, 0, 0, bufferCanvas.width, bufferCanvas.height);\n}\n\n//# sourceURL=webpack:///./game/index.js?");

/***/ }),

/***/ "./game/managers/GameStateManager.js":
/*!*******************************************!*\
  !*** ./game/managers/GameStateManager.js ***!
  \*******************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar GameStateManager = function GameStateManager() {\n  var isStarted = false;\n  var state = {};\n  var tileW = undefined;\n  var tileH = undefined;\n  var processState = \"LOADING\";\n\n  var getIsStarted = function getIsStarted() {\n    return isStarted;\n  };\n\n  var getProcessState = function getProcessState() {\n    return processState;\n  };\n\n  var updateProcessState = function updateProcessState(newProcessState) {\n    processState = newProcessState;\n  };\n\n  var getState = function getState() {\n    return state;\n  };\n\n  var getConfig = function getConfig() {\n    return {\n      tileW: tileW,\n      tileH: tileH\n    };\n  };\n\n  var initMaps = function initMaps(maps, canvasWidth, canvasHeight) {\n    var rowsCount = maps.length;\n    var colsCount = maps[0].length;\n    tileW = canvasWidth / colsCount;\n    tileH = canvasHeight / rowsCount;\n  };\n\n  var updateState = function updateState(newState) {\n    state = Object.assign(state, newState);\n    console.log(state.shots);\n  };\n\n  var startGame = function startGame() {\n    isStarted = true;\n  };\n\n  return {\n    getProcessState: getProcessState,\n    updateProcessState: updateProcessState,\n    getIsStarted: getIsStarted,\n    getState: getState,\n    getConfig: getConfig,\n    updateState: updateState,\n    initMaps: initMaps,\n    startGame: startGame\n  };\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (GameStateManager);\n\n//# sourceURL=webpack:///./game/managers/GameStateManager.js?");

/***/ }),

/***/ "./game/managers/ImageManager.js":
/*!***************************************!*\
  !*** ./game/managers/ImageManager.js ***!
  \***************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils_imgLoader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/imgLoader */ \"./game/utils/imgLoader.js\");\n/* harmony import */ var _public_imgs_tank_jpg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../public/imgs/tank.jpg */ \"./public/imgs/tank.jpg\");\n/* harmony import */ var _public_imgs_tank_jpg__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_public_imgs_tank_jpg__WEBPACK_IMPORTED_MODULE_1__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\nvar ImageManager = function ImageManager() {\n  var tank;\n\n  var getImgs = function getImgs() {\n    return {\n      tank: tank\n    };\n  };\n\n  var load =\n  /*#__PURE__*/\n  function () {\n    var _ref = _asyncToGenerator(\n    /*#__PURE__*/\n    regeneratorRuntime.mark(function _callee() {\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              _context.prev = 0;\n              _context.next = 3;\n              return Object(_utils_imgLoader__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_public_imgs_tank_jpg__WEBPACK_IMPORTED_MODULE_1___default.a);\n\n            case 3:\n              tank = _context.sent;\n              _context.next = 8;\n              break;\n\n            case 6:\n              _context.prev = 6;\n              _context.t0 = _context[\"catch\"](0);\n\n            case 8:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee, null, [[0, 6]]);\n    }));\n\n    return function load() {\n      return _ref.apply(this, arguments);\n    };\n  }();\n\n  return {\n    load: load,\n    getImgs: getImgs\n  };\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (ImageManager);\n\n//# sourceURL=webpack:///./game/managers/ImageManager.js?");

/***/ }),

/***/ "./game/managers/TouchPadManager.js":
/*!******************************************!*\
  !*** ./game/managers/TouchPadManager.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar TouchPadManager = function TouchPadManager(_ref) {\n  var canvasWidth = _ref.canvasWidth,\n      canvasHeight = _ref.canvasHeight;\n  //touchpad\n  var bgBallR = canvasWidth / 10;\n  var bgBallX = 0 + bgBallR;\n  var bgBallY = canvasHeight - 2 * bgBallR;\n  var ballX = bgBallX;\n  var ballY = bgBallY;\n  var sinE = 0;\n  var cosE = 0;\n  var ballR = bgBallR / 3;\n  var ballDrX = 0.5;\n  var ballDrY = Math.sqrt(Math.abs(1 - Math.pow(ballDrX, 2))); //touchpad btn\n\n  var btnPressed = false;\n  var btnWidth = canvasWidth / 10;\n  var btnHeight = btnWidth;\n  var btnX = canvasWidth - btnWidth - btnWidth / 10;\n  var btnY = canvasHeight - btnHeight - btnHeight / 10;\n  var btnStartX = btnX;\n  var btnEndX = btnX + btnWidth;\n  var btnStartY = btnY;\n  var btnEndY = btnY + btnHeight;\n\n  var updateBallPosition = function updateBallPosition(n) {\n    ballX = bgBallX + n.distanceX;\n    ballY = bgBallY + n.distanceY;\n    sinE = n.sinE;\n    cosE = n.cosE;\n  };\n\n  var getStatus = function getStatus() {\n    return {\n      bgBallR: bgBallR,\n      bgBallX: bgBallX,\n      bgBallY: bgBallY,\n      ballX: ballX,\n      ballY: ballY,\n      ballR: ballR,\n      ballDrX: ballDrX,\n      ballDrY: ballDrY,\n      sinE: sinE,\n      cosE: cosE,\n      btnWidth: btnWidth,\n      btnHeight: btnHeight,\n      btnX: btnX,\n      btnY: btnY,\n      btnPressed: btnPressed\n    };\n  };\n\n  var deactivePressed = function deactivePressed() {\n    btnPressed = false;\n  };\n\n  var startHandler = function startHandler(_ref2) {\n    var mouseX = _ref2.mouseX,\n        mouseY = _ref2.mouseY;\n\n    if (mouseX >= btnStartX && mouseX <= btnEndX && mouseY >= btnStartY && mouseY <= btnEndY) {\n      btnPressed = true;\n    }\n  };\n\n  var endHandler = function endHandler(_ref3) {\n    var mouseX = _ref3.mouseX,\n        mouseY = _ref3.mouseY;\n\n    if (mouseX <= canvasWidth / 2) {\n      //왼쪽 땜\n      updateBallPosition({\n        distanceX: 0,\n        distanceY: 0,\n        sinE: 0,\n        cosE: 0\n      });\n    } else {//오른쪽 땜\n    }\n  };\n\n  var moveHandler = function moveHandler(_ref4) {\n    var mouseX = _ref4.mouseX,\n        mouseY = _ref4.mouseY;\n    var distanceX = mouseX - bgBallX;\n    var distanceY = mouseY - bgBallY;\n    var distanceR = Math.sqrt(Math.pow(distanceX, 2) + Math.pow(distanceY, 2));\n    var sinE = distanceY / distanceR;\n    var cosE = distanceX / distanceR;\n\n    if (distanceR <= bgBallR) {\n      updateBallPosition({\n        distanceX: distanceX,\n        distanceY: distanceY,\n        sinE: sinE,\n        cosE: cosE\n      });\n    }\n  };\n\n  return {\n    updateBallPosition: updateBallPosition,\n    getStatus: getStatus,\n    moveHandler: moveHandler,\n    startHandler: startHandler,\n    endHandler: endHandler,\n    deactivePressed: deactivePressed\n  };\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (TouchPadManager);\n\n//# sourceURL=webpack:///./game/managers/TouchPadManager.js?");

/***/ }),

/***/ "./game/managers/UserManager.js":
/*!**************************************!*\
  !*** ./game/managers/UserManager.js ***!
  \**************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar imgLoader = function imgLoader(src) {\n  return new Promise(function (resolve) {\n    var img = new Image();\n\n    img.onload = function () {\n      resolve(img);\n    };\n\n    img.src = src;\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (imgLoader);\n\n//# sourceURL=webpack:///./game/utils/imgLoader.js?");
...
eval("module.exports = \"/public/imgs/tank.jpg\";\n\n//# sourceURL=webpack:///./public/imgs/tank.jpg?");

/***/ }),

/***/ 0:
/*!*********************************************!*\
  !*** multi @babel/polyfill ./game/index.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! C:\\Users\\rlgus\\development\\projects\\game\\game\\index.js */\"./game/index.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./game/index.js?");
